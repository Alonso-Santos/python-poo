# ====================================================================================
#ESCOLA DO FUTURO E GOIÁS (EFG) - SISTEMA INTEGRADO
# Aula 04 - Herança de Classes e Relacionamentos de Agregação
# ====================================================================================

# 1. SUPER CLASSE (Classe Pai): Reúne atributos comuns a qualquer pessoa no sistema
class Usuario:
...
# 2. SUB CLASSE (Classe Filho): herda tudo de Usuario e adiciona especificidades
class Aluno(Usuario):
    ...
    # SOBRE ESCRITA DE MÉTODO (Method Overriding)
    # Customizamos o exibir_dados() herdado do pai para adicionar dados do Aluno
    def exibir_dados(self):
        print(f" [ESTUDANTE] Nome: {self.nome} | Matricula: {self.matricula} | Notas: {self.__notas}")
...
if __name__ == "__main__":
    ...
    estudante_1 = Aluno("Alonso Santos", "alonso@efg.com", "EFG-2026-101")
    estudante_2 = Aluno("Beatriz Souza", "bea@efg.com", "EFG-2026-102")

    # Lançando notas parciais
    estudante_1.lancar_nota(10.0)
    estudante_2.lancar_nota(8.8)

    # Instanciando o Curso (O contêiner de Agregação)
    curso_dev = Curso("Técnico em Desenvolvimento Web e Mobile || - EFG")

    # Realizando a Agregação na prática (Matriculando os objetos aluno no curso)
    curso_dev.matricular_estudante(estudante_1)
    curso_dev.matricular_estudante(estudante_2)
